...
<div class="aboutUs CustomPending bgLighGrey">
    <div class="SecondShape">
        <img src="assets/images/product-Back.png" alt="">
    </div>
    <div class="container">

        <div class="secTitle">
            <div class="AboutSecTitleWrapper">
                <h5>
                    <div class="dots"></div>About Us
                </h5>
                <div class="aboutSketch">
                    <img src="assets/images/drop-img.png" alt="">
                </div>
            </div>
            <div class="desc">
            ...
            <div class="counterContent">
                <div class="counterContentItem">
                    <div class="countWrapper">
                        <span class="count" data-target="08">0</span>
                        <span>+</span>
                    </div>
                    <p>Environment Protection Industry</p>
                </div>
...
<div class="text-slider-area">
    <div class="text-slider-box">
        <div class="text-slider fade-anim">
...
<div class="productSec CustomPending">
...
<div class="productSec CustomPending pt-0">
    <div class="container container-2xl">
...
<div class="ourApplication CustomPending">
    <div class="container ">
        <div class="secBigTitle">
            ...
            ?>
                <div class="ourApplicationItem">
                    ...
                    <div class="ourApplicationContent">
                        <h5><?php echo str_replace("-", " ", str_replace(".png", "", str_replace(".jpg", "", str_replace(".webp", "", str_replace("assets/images/application/", "", $p))))); ?></h5>
                    </div>
                </div>
            <?php
            }
    ...
    <div class="swiper ourApplicationSwiper">
        <div class="swiper-wrapper">
...
<div class="clientSec CustomPending bgLighGrey">
    <div class="container">
        <div class="secBigTitle">
            <h5>Stronger Together</h5>
        </div>
    </div>
